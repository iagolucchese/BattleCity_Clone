...
public class ShotController : MonoBehaviour {
	...
	void Start()
	{
		...
		rigidbody2D.AddForce(new Vector2(Mathf.Sin(-rotation)*100*speed,Mathf.Cos(-rotation)*100*speed)); //the sin and cosin functions basically work to return either -1, 0, or 1, to determine the direction of the force
	}
